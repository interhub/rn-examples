...
const LeftScreen = () => {
  ...
  const [imageStyle1] = useGetShowAnimatedStyle(
    (setPoints) => {
      'worklet'
      return {
  ...
  return (
    <View style={{flex: 1}}>
      <View style={styles.container}>
        ...
        {/*    {text}*/}
        {/*</Animated.Text>*/}
        <Animated.Text style={[styles.text, titleStyle]}>{text}</Animated.Text>
        <Animated.Image style={[styles.image, imageStyle1]} resizeMode="cover" source={require('../img/bg.jpg')} />
