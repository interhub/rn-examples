...
//
// AppMetrica.activate({
//     apiKey: 'a98385fc-5d70-4a91-819b-cafe63f1352b',
//     sessionTimeout: 120,
//     firstActivationAsUpdate: true,
//     locationTracking: true
// })
//
// AppMetrica.setUserProfileID('123123')
...
const styles = StyleSheet.create({
    ...
    header: {
        height: HEADER_SIZE, backgroundColor: 'blue',
        position: 'absolute', width: '100%', zIndex: 10,
    },
    title: {
        textAlign: 'center', marginTop: 'auto', color: '#FFF', fontSize: 20
    }
})
