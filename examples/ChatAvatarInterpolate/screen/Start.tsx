  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footerBox}>
        <TextInputCustom {...inputProps} placeholder={'Сообщение'} showSendBtn />
      </View>
    </View>
  )
}
...
const MessageBlock = (props: MessageType & {scrollAnimateValue: Animated.Value; messagesOrder?: string}) => {
  const {avatar, username, text, scrollAnimateValue, messagesOrder} = props
  ...
  return (
    <View
      ...
      <View style={styles.textBox}>
        <Text selectable style={{color: '#fff', fontWeight: 'bold', paddingBottom: 5}}>
          {username}
        </Text>
